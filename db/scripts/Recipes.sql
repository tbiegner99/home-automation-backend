...
CREATE TABLE `ingredients` (
  ...
  CONSTRAINT `recipe` FOREIGN KEY (`recipe`) REFERENCES `recipe` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recipe_keywords` (
  ...
  KEY `keyword` (`keyword`),
  CONSTRAINT `recipe_keyword` FOREIGN KEY (`recipe`) REFERENCES `recipe` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-02-06  1:44:59
