...
import SongsDatasource from '../../../../src/datasource/songs/datasource.js';
import mapper from '../../../../src/datasource/songs/row-mapper.js';
import queries from '../../../../src/datasource/songs/queries.js';
...
describe('Songs Datasource', () => {
    ...
    beforeEach(() => {
        ...
        jest.spyOn(DBClientFactory, 'getClient').mockReturnValue(mockClient);
